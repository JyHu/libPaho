Pod::Spec.new do |s|
  ...
  s.subspec '3a' do |ss|
    ...
    ss.vendored_frameworks = "libPahoC/libs/libpaho-mqtt3a.a"
  end
  ...
  s.subspec '3as' do |ss|
    ...
    ss.vendored_frameworks = "libPahoC/libs/libpaho-mqtt3as.a"
  end
  
  # 同步包
  s.subspec '3c' do |ss|
    ss.source_files = "libPahoC/headers/*.h"
    ss.vendored_frameworks = "libPahoC/libs/libpaho-mqtt3c.a"
  end
  ...
  s.subspec '3cs' do |ss|
    ss.source_files = "libPahoC/headers/*.h"
    ss.dependency "libPahoC/ssl"
    ss.vendored_frameworks = "libPahoC/libs/libpaho-mqtt3cs.a"
  end
  
  # 异步paho需要的openssl依赖
  s.subspec 'ssl' do |ss|
    ss.source_files = "libssl/include/**/*.h"
    ss.vendored_frameworks = "libssl/lib/*.a"
  end
end
